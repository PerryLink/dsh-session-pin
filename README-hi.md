...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.2` (GitHub tag, 2026-09-22 को सत्यापित: दोहरी-रूलर typecheck + unit/composition सूट + स्थैतिक सीम जाँच; ब्राउज़र दौर अनुरक्षक के पास)। npm पिन `0.1.7-alpha.2`, peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0 || >=0.1.6-0 <0.2.0 || >=0.1.7-0 <0.2.0`। |
