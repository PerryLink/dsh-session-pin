...
| Superfície | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.3-alpha.1` (tag do GitHub; verificado em 2026-09-06: cadeia completa de portas + smoke de instalação de perfil). Pin npm `0.1.2-rc.1`, peers `>=0.1.2-rc.1 <0.2.0`. |
