...
| Superficie | Estado |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.3-alpha.1` (tag de GitHub; verificado el 2026-09-06: cadena completa de puertas + smoke de instalación de perfil). Pin npm `0.1.2-rc.1`, peers `>=0.1.2-rc.1 <0.2.0`. |
